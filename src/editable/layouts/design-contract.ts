...
export const editableRootStyle = {
  // Nevire-style premium agency system on a LIGHT canvas: warm off-white pages,
  // white cards, near-black ink, hairline warm borders and one botanical-green
  // accent. Footer + the big CTA stay dark as deliberate contrast bands. The
  // brand name loads from env via SITE_CONFIG. Change the palette here only.
  '--slot4-page-bg': '#f5f4ef',
  '--slot4-page-text': '#16181c',
  '--slot4-panel-bg': '#edece5',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#5f635d',
  '--slot4-soft-muted-text': '#8c8f88',
  '--slot4-accent': '#2e7d32',
  '--slot4-accent-fill': '#2e7d32',
  '--slot4-accent-soft': '#e6f1e4',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#16181c',
  '--slot4-dark-text': '#f4f4f1',
  '--slot4-media-bg': '#e9e8e1',
  '--slot4-cream': '#faf9f5',
  '--slot4-warm': '#eeede6',
  '--slot4-lavender': '#faf9f5',
  '--slot4-gray': '#edece5',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#f5f4ef',
  '--editable-page-text': '#16181c',
  '--editable-container': '1240px',
  '--editable-border': '#e2e0d6',
  '--editable-nav-bg': '#f5f4ef',
  '--editable-nav-text': '#16181c',
  '--editable-nav-active': '#2e7d32',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#2e7d32',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#16181c',
  '--editable-footer-text': '#f4f4f1',
} as CSSProperties
...
export const editablePalette = {
  ...
  shadow: 'shadow-[0_1px_3px_rgba(22,33,28,0.08)]',
  shadowStrong: 'shadow-[0_18px_50px_rgba(22,33,28,0.12)]',
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-semibold leading-[1.05] tracking-[-0.02em] sm:text-5xl lg:text-[3.5rem]',
  ...
  motion: {
    lift: 'transition duration-300 hover:-translate-y-1 hover:border-[var(--slot4-accent)]/40 hover:shadow-[0_14px_34px_rgba(22,33,28,0.12)]',
